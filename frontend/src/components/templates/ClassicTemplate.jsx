...
//             const year = parts[0];
//             const month = parts[1] || 1; // Fallback to January if month missing
...
//             });
//         } catch (e) {
//             return dateStr; // Fallback to raw string if error
//         }
//     };

//     return (
//         <div className="max-w-4xl mx-auto p-8 bg-white text-gray-800 leading-relaxed shadow-lg my-4">
//             {/* Header */}
//             <header className="text-center mb-8 pb-6 border-b-2" style={{ borderColor: accentColor }}>
//                 <h1 className="text-4xl font-bold mb-3 uppercase tracking-tight" style={{ color: accentColor }}>
...
//                     <h2 className="text-lg font-bold mb-2 border-b border-gray-200 pb-1" style={{ color: accentColor }}>
//                         PROFESSIONAL SUMMARY
//                     </h2>
...
//                 <section className="mb-8">
//                     <h2 className="text-lg font-bold mb-4 border-b border-gray-200 pb-1" style={{ color: accentColor }}>
...
//                                     </span>
//                                 </div>
//                                 <p className="text-gray-800 font-medium text-sm italic">{exp.company}</p>
//                                 {exp.description && (
...
//                                     {edu.gpa && <p className="text-gray-600 font-medium">GPA: {edu.gpa}</p>}
//                                 </div>
...
//                 <section>
//                     <h2 className="text-lg font-bold mb-3 border-b border-gray-200 pb-1" style={{ color: accentColor }}>
//                         CORE SKILLS
//                     </h2>
